        ...
        <div class="container">
            ...
            <div class="row">
                ...
                @foreach ($lapangan as $p)
                    <div class="col-md-4">
                        <div class="product ftco-animate" style="background-color: #c70039">
                            <div class="">
                                <a href="#" data-toggle="modal" data-target="#detail<?= $no ?>">
                                    ...
                                    <div class="text text-center">
                                        <h2 class="text-white">{{ $p->namalapangan }}</h2>
                                        <p class="mb-0"><span class="price text-white">Rp
